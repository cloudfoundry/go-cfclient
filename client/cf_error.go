...
// 2022-10-06 14:02:19.611346 -0700 PDT m=+0.284552455
...
func NewRateLimitV2APIExceededError() CloudFoundryError {
	return CloudFoundryError{
		Code:        10018,
		ErrorCode:   "CF-RateLimitV2APIExceeded",
...
func NewOrgQuotaLogRateLimitExceededError() CloudFoundryError {
	return CloudFoundryError{
		Code:        100010,
		ErrorCode:   "CF-OrgQuotaLogRateLimitExceeded",
		Description: "You have exceeded your organization's log rate limit: %s",
	}
}
...
func NewServiceBrokerSyncFailedError() CloudFoundryError {
	return CloudFoundryError{
		Code:        270022,
		ErrorCode:   "CF-ServiceBrokerSyncFailed",
		Description: "Encountered an error while attempting to sync cloud controller with the service broker's catalog: %s",
	}
}
...
func NewSpaceQuotaLogRateLimitExceededError() CloudFoundryError {
	return CloudFoundryError{
		Code:        310011,
		ErrorCode:   "CF-SpaceQuotaLogRateLimitExceeded",
		Description: "You have exceeded your space's log rate limit: %s",
	}
}
