...
func TestCreateOrganization(t *testing.T) {
	Convey("Create  Organization", t, func() {
		...
		organization, err := client.CreateOrganization(v3.CreateOrganizationRequest{
			Name: "my-org",
		})
		So(err, ShouldBeNil)
...
func TestUpdateOrganization(t *testing.T) {
	Convey("Update  Organization", t, func() {
		...
		organization, err := client.UpdateOrganization("org-guid", v3.UpdateOrganizationRequest{
			Name: "my-org",
		})
		So(err, ShouldBeNil)
		So(organization, ShouldNotBeNil)
