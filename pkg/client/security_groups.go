...
func (c *Client) ListSecurityGroupsByQuery(query url.Values) ([]v3.SecurityGroup, error) {
	...
	for {
		...
		var data v3.ListSecurityGroupResponse
...
func (c *Client) CreateSecurityGroup(r v3.CreateSecurityGroupRequest) (*v3.SecurityGroup, error) {
	...
	var securitygroup v3.SecurityGroup
...
func (c *Client) UpdateSecurityGroup(GUID string, r v3.UpdateSecurityGroupRequest) (*v3.SecurityGroup, error) {
...
func (c *Client) GetSecurityGroupByGUID(GUID string) (*v3.SecurityGroup, error) {
